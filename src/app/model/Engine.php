...
class Engine
{
    ...
    public function __construct($applications, $clusterNodesConfigured, $clusterNodesRunning, $licensedUsers, $processModelVersions, $processModelVersionsDeleted, $processModels, $runningCases, $runningTasks, $upTime, $users, $version)
    {
